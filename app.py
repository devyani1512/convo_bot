...
# ✅ Show the OpenAI SDK version in logs and on screen
st.title("🔍 OpenAI Version Check")
st.write("OpenAI SDK version in use:")
st.code(openai.__version__, language="bash")

# ✅ Also print to server logs
print("✅ OpenAI version from code:", openai.__version__)
